...
THREE.DoFShader = {
	...
	uniforms: {
		...
		"focalLength":	{ type: "f", value: 50.0 },
		"fstop":		{ type: "f", value: 0.1 },
	...
	fragmentShader: [
		...
		"float ndofstart = 80.0;", //near dof blur start
		"float ndofdist = 60.0;", //near dof blur falloff distance
		"float fdofstart = 0.0;", //far dof blur start
		"float fdofdist = 100.0;", //far dof blur falloff distance

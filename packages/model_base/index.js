...
export function createModelBase() {
  ...
  DefaultLoadingManager.onStart = () => { pendingAssets = true; };
  DefaultLoadingManager.onLoad = () => { pendingAssets = false; };
  let autoRotate = !thumbnailMode;
  let velocity = 0;
  let t = thumbnailMode ? 0.65 : 0;
  ...
  function handleAnimationFrame() {
    ...
    update();
    render();
    if (thumbnailMode && !pendingAssets) {
